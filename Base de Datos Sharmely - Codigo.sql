-- Codigo crear base de datos y Tablas Empresa Sharmely V1
...
-- Tabla Usuario (Relacionada con Cliente - ahora opcional y con rol)
...
CREATE TABLE Detalle_Pedido (
    ...
    subtotalDetPedido DECIMAL(10,2) NULL, -- Ahora permite NULL
